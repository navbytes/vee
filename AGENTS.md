...
**Writing a plugin rather than working on Vee itself?** `plugins/AGENTS.md` has the
contract — it loads on its own when you are working under `plugins/`, and
`docs/_content/plugin-authoring.md` is the full reference behind it.
