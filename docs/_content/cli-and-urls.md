...
The four authoring and debugging commands — `vee render`, `vee show`, `vee dev`,
and `vee lint` — have their own page: [Debugging and testing
plugins](debugging.md). The remaining subcommands are documented below.
